...
<!--css-->
<link href="css/pgbootstrap.css" rel="stylesheet" type="text/css" media="all"/>
<link href="css/pgstyle.css" rel="stylesheet" type="text/css" media="all" />
<link href="css/pgfont-awesome.css" rel="stylesheet">
<!--css-->
				...
				<div class="container">
					<div class="logo-nav">
						<div class="logo-nav-left">
							<h1><a href="index.html">eBid.Com <span>Bid anywhere</span></a></h1>
						</div>
									...
									<div id="myTabContent" class="tab-content">
										<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
											<div class="product-tab">
												...
												$s=mysqli_query($con,"select * from products where status=1");											
												...
												echo '<form action="bid.php" method="post">
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img src="uploads//'.$row['pimage'].'" class="img-responsive" alt="">
																	</div>
														...
														<div class="women">
															...
															<span class="size">Starting Price: Rs. '.$row['sprice'].'</span>
															<span class="size">Starting Date:  '.$row['sdate'].'</span>
															<span class="size">Ending Date: '.$row['edate'].'</span>
																													</div>
													</div>
